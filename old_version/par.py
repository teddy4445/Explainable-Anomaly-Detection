...
from old_version.experiments import FeatureDistributionNormal
from old_version.experiments.synthetic_dataset_generation import SyntheticDatasetGeneration
...
if __name__ == '__main__':
    ...
    Main.run(create_corpus=False,
             f_diff=None,
             run_experiments=True,
             supervised=True,  # True, False
             time_limit_seconds=600,
             corpus_name="partial_T_Corpus_fixed")  # DBSCAN_rc50_pmNone, partial_synthetic, T_Corpus_fixed, partial_T_Corpus_fixed
